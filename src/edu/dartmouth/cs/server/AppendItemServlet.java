...
public class AppendItemServlet extends HttpServlet {
	...
	protected static final Logger logger = Logger.getLogger(AppendItemServlet.class
			.getName());
...
//			EntryDatastore.removeAllEntries();
			...
			JSONObject entryJson = new JSONObject(req.getParameter("entry"));
			logger.info("Received an entry append request");
